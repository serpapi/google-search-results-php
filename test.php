...
class GoogleSearchResultsTest extends TestCase {
    ...
    'location' => "Portland"
      ...
      $serp = new GoogleSearchResults('ILOVETRUMP');
      $this->assertEquals($QUERY['q'], 'Coffee');
      $rsp = $serp->search('json', 'json', $QUERY);
...
//        $api->parse_response($RESPONSE);
//        
//        $this->assertEquals(["HTTP/1.1 100 Continue", "HTTP/1.1 200 
//OK"], 
//            $api->response_status_lines);
//        $this->assertEquals((object) [
